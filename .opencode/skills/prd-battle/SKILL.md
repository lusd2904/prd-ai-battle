...
| `advisor-lightning` | `nvidia/nemotron-3.5-lightning:free` via OpenRouter | Never (`tools=[]`, edit/shell deny) |
| `advisor-ling` | `inclusionai/ling-3.0-flash-fin:free` via OpenRouter | Never |
| `advisor-ultra` | `nvidia/nemotron-3-ultra-550b-a55b:free` via OpenRouter | Never |
| `advisor-router` | `openrouter/free` via OpenRouter | Never |
