---
description: phase=execute — only primary may write v1 under write_lock
agent: primary
---

Open write_lock for the **primary only**.
...
Rules for this turn:
- You are `primary` on `claude-opus-5`. You MAY write files.
