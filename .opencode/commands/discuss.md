...
5. Produce a shared discussion covering ★ must-respond clauses, scoring points, and 废标风险, then recommend 对照表 fills (条款 / 是否响应 / 证据页码 / 意见 / 状态).
6. Do not write draft files. When the user is ready they will run `/lock`.
